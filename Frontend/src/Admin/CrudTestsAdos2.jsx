...
const CrudTestsAdos2 = () => {
    ...
    const fetchTests = () => {
        axios.get("http://localhost:5000/api/admin/tests-ados", { headers: { Authorization: `Bearer ${token}` } })
    ...
    const handleSubmit = e => {
        e.preventDefault();
        if (editId) {
            axios.put(`http://localhost:5000/api/admin/tests-ados/${editId}`, form, { headers: { Authorization: `Bearer ${token}` } })
    ...
    const handleDelete = id =>
        ...
        axios.delete(`http://localhost:5000/api/admin/tests-ados/${id}`, { headers: { Authorization: `Bearer ${token}` } }).then(fetchTests);
