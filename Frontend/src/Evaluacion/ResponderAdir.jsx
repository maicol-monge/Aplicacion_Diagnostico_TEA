...
const ResponderAdir = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/adir/preguntas-con-respuestas/${id_adir}`, {
        ...
        axios.get(`http://localhost:5000/api/adir/id-paciente/${id_adir}`, {
            headers: { Authorization: `Bearer ${token}` }
        }).then(res => {
            setIdPaciente(res.data.id_paciente);
        });
        axios.get("http://localhost:5000/api/adir/codigos-por-pregunta", {
            headers: { Authorization: `Bearer ${token}` }
    ...
    const guardarRespuesta = async (id_pregunta, codigo, observacion) => {
        ...
        try {
            await axios.post(
                "http://localhost:5000/api/adir/guardar-respuesta",
