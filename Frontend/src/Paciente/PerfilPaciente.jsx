...
const GENERIC_AVATAR = "https://ui-avatars.com/api/?name=Paciente&background=cccccc&color=555555&size=64";
...
const PerfilPaciente = () => {
    ...
    useEffect(() => {
        const fetchPaciente = async () => {
            try {
                ...
                Swal.fire({
                    title: "Error",
                    text: "No se pudo cargar el perfil del paciente.",
                    icon: "error",
        ...
        if (user?.id_usuario) fetchPaciente();
    }, [user]);
    ...
    const handlePasswordChange = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.put(
                "http://localhost:5000/api/users/cambiar-password",
                {
                    ...
                    <div className="col-12 col-md-10 col-lg-8">
                        ...
                        >
                            ...
                            {loading ? (
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-12 col-md-8">
                                            <div className="row">
                                                ...
                                                <div className="col-12 col-sm-6 mb-3">
                                                    <span style={{ color: COLOR_PRIMARY, fontWeight: "bold" }}>Sexo:</span>
                                                    <div>{paciente?.sexo}</div>
                                                </div>
                                                <div className="col-12 col-sm-6 mb-3">
                                                    <span style={{ color: COLOR_PRIMARY, fontWeight: "bold" }}>Fecha de nacimiento:</span>
                                                    <div>{paciente?.fecha_nacimiento ? new Date(paciente.fecha_nacimiento).toLocaleDateString() : "No registrada"}</div>
                                                </div>
                                                <div className="col-12 col-sm-6 mb-3">
                                ...
                                <div className="text-center text-danger">No se encontró información del paciente.</div>
                            )}
                        </div>
                    </div>
                </div>
