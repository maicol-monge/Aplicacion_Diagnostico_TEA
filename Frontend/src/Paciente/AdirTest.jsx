...
const AdirTest = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/paciente/buscar-por-usuario/${id_usuario}`, {
            headers: {
        ...
        axios.get("http://localhost:5000/api/adir/preguntas-test", {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
    ...
    const handleSubmit = () => {
        ...
        const token = localStorage.getItem("token");
        axios.post("http://localhost:5000/api/adir/crear-con-respuestas", payload, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
