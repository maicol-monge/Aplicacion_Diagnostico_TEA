...
const Reportes = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/especialistas/reportes/pacientes-con-tests${query}`, {
        ...
        if (test.tipo === "ADOS-2" && test.modulo === "T") {
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/ados/reporte-modulo-t/${test.id_ados}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            ...
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/ados/reporte-modulo-1/${test.id_ados}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            ...
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/ados/reporte-modulo-2/${test.id_ados}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            ...
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/ados/reporte-modulo-3/${test.id_ados}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            ...
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/ados/reporte-modulo-4/${test.id_ados}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
            ...
            try {
                const res = await axios.get(
                    `http://localhost:5000/api/adir/resumen-paciente/${test.id_adir}`,
                    { headers: { Authorization: `Bearer ${token}` } }
                );
